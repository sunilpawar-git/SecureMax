...
```mermaid
flowchart TB
    classDef strat fill:#1e3a8a,stroke:#3b82f6,stroke-width:2px,color:#eff6ff;
    classDef oper fill:#064e3b,stroke:#10b981,stroke-width:2px,color:#ecfdf5;
    classDef case fill:#701a75,stroke:#d946ef,stroke-width:2px,color:#fdf4ff;
    classDef func fill:#1e293b,stroke:#475569,stroke-width:2px,color:#f8fafc;

    Strategic["Strategic Level<br>(Unit Chief & Executive Relationship)"]:::strat
    Operational["Operational Level<br>(Technical & Departmental Systems)"]:::oper
    Case["Case Level<br>(Individual Inquiries & Investigators)"]:::case

    Funcs["Core Management Functions<br>• Planning<br>• Organizing<br>• Directing / Staffing<br>• Coordinating<br>• Controlling"]:::func
...
```mermaid
flowchart TD
    classDef prop fill:#064e3b,stroke:#10b981,stroke-width:2px,color:#ecfdf5;
    classDef outs fill:#7f1d1d,stroke:#f87171,stroke-width:2px,color:#fee2e2;
    classDef hybrid fill:#1e293b,stroke:#94a3b8,stroke-width:2px,color:#f8fafc;

    Decision{Investigative Resource Strategy}

    Decision -- Proprietary/Internal --> Prop[Internal Unit]:::prop
    Decision -- Outsourced/Contract --> Outs[Contract Vendors]:::outs
    Decision -- Combined Approach --> Hybrid[Hybrid/Co-Sourced]:::hybrid

    Prop --> P1[Culture Alignment]:::prop
    Prop --> P2[Rapid Deployment]:::prop
    Prop --> P3[Deep Internal Network]:::prop

    Outs --> O1[Variable Costs]:::outs
    Outs --> O2[Specialized Skills]:::outs
    Outs --> O3[Unbiased Objectivity]:::outs
...
```mermaid
flowchart LR
    classDef phase fill:#1e293b,stroke:#94a3b8,stroke-width:2px,color:#f8fafc;
    classDef detail fill:#0f172a,stroke:#475569,stroke-width:1px,color:#cbd5e1;

    P1[1. Initiation]:::phase --> P2[2. Investigation]:::phase
    P2 --> P3[3. Reporting]:::phase
    P3 --> P4[4. Resolution]:::phase

    subgraph Initiation_Details ["Initiation Phase"]
        D1[• Incident Reports<br>• Audits & Discrepancies<br>• Hotline Complaints]:::detail
    end
    subgraph Investigation_Details ["Investigation Phase"]
        D2[• Evidence Collection<br>• Interviews / Interrogations<br>• Surveillance / OSINT]:::detail
    end
    subgraph Reporting_Details ["Reporting Phase"]
        D3[• Case Log Chronology<br>• Witness Statements<br>• Facts & Exhibits]:::detail
    end
    subgraph Resolution_Details ["Resolution Phase"]
        D4[• Policy Discipline / Termination<br>• Restitution / Recovery<br>• Law Enforcement Referral]:::detail
    end
...
```mermaid
flowchart TD
    classDef step fill:#1e3a8a,stroke:#3b82f6,stroke-width:2px,color:#eff6ff;

    S1["<b>Step 1: Requirements</b><br>Define gathering objectives & specific questions"]:::step
    S2["<b>Step 2: Collection</b><br>Gather raw data from internal & external sources"]:::step
    S3["<b>Step 3: Processing & Analysis</b><br>Collate, evaluate, & convert data into intelligence"]:::step
    S4["<b>Step 4: Dissemination</b><br>Deliver tailored products to decision makers"]:::step
    S5["<b>Step 5: Evaluation</b><br>Assess operations & identify areas for improvement"]:::step
...
```mermaid
flowchart TD
    classDef decision fill:#0f172a,stroke:#3b82f6,stroke-width:2px,color:#eff6ff;
...
```mermaid
flowchart TD
    classDef question fill:#1e3a8a,stroke:#3b82f6,stroke-width:2px,color:#eff6ff;
    classDef decision fill:#064e3b,stroke:#10b981,stroke-width:2px,color:#ecfdf5;
    classDef warning fill:#7f1d1d,stroke:#f87171,stroke-width:2px,color:#fee2e2;

    Start([Considerations Before Undercover Investigation]) --> Q1{Is covert feasibility high?}
    Q1 -- No --> ActionStop[Undercover Not Recommended]:::warning
    Q1 -- Yes --> Q2{How will confidentiality be maintained?}:::question

    Q2 --> Q3{How long can cover be maintained?}:::question
    Q3 --> Q4{How to avoid cover-up allegations?}:::question
    Q4 --> Q5{Who should be on the team?}:::question
    Q5 --> Q6{Is voluntary disclosure/self-reporting required?}:::question
    Q6 --> Q7{When does the investigation become overt?}:::question

    Q7 --> Approve([Meticulously Planned & Approved Operation]):::decision
```
...
```mermaid
flowchart TD
    classDef center fill:#1e3a8a,stroke:#3b82f6,stroke-width:2px,color:#eff6ff;
    classDef resource fill:#1e293b,stroke:#475569,stroke-width:2px,color:#f8fafc;

    Center(["<b>JOINT TASK FORCE (JTF)</b><br>Cross-Jurisdictional & Multidisciplinary Operations"]):::center

    R1["<b>Staffing Resources</b><br>• Local, state & federal agents<br>• Investigators & prosecutors"]:::resource
    R2["<b>Intelligence Resources</b><br>• Shared databases<br>• Threat intelligence feeds"]:::resource
    R3["<b>Local Law Enforcement</b><br>• Jurisdictional authority<br>• Tactical teams"]:::resource
    R4["<b>Public & Industry Resources</b><br>• Private security managers<br>• Analysts & technical specialists"]:::resource
...
flowchart TD
    ...
    Plan["1. PLAN<br>• Identify & analyze problems<br>• Assess and rank assets<br>• Establish objectives"]:::step
    Do["2. DO<br>• Prioritize next steps<br>• Develop detailed action plan<br>• Implement the plan"]:::step
    Check["3. CHECK<br>• Monitor & measure processes<br>• Compare outcomes against objectives<br>• Analyze results"]:::step
    Act["4. ACT<br>• Standardize successful solutions<br>• Address remaining gaps<br>• Begin the cycle again"]:::step
