...
We hope that this _Physical Security Audit Manual (PSAM)_ becomes an important source of professional insight and stimulates serious, ongoing dialogue among security professionals. Any reader grappling with an unusual, novel, or difficult security problem is encouraged to write a succinct statement describing the issue and share it with the team via the **Raivan Global Professional Portal**.
...
This approach of first learning about the organization and its goals and objectives results in the message to stakeholders that _"security's purpose is to help you achieve your goals"_ and that _"we want what you want."_ This alignment increases stakeholder engagement and reduces the perception of security as a hindrance or obstacle to doing business, thus enabling more effective risk management.
...
graph TD
    ...
    classDef process fill:#0f172a,stroke:#38bdf8,stroke-width:2px,color:#f0f9ff;
    classDef support fill:#064e3b,stroke:#34d399,stroke-width:2px,color:#ecfdf5;

    A["1. Identify & Prioritize Assets"]:::process --> B["2. Identify & Prioritize Risks"]:::process
    B --> C["3. Mitigate Prioritized Risks"]:::process
    C --> D["4. Continuous Improvement"]:::support
    D --> A

    subgraph Context & Foundation
        E["Organizational Context"]:::default
        F["Foundation of ESRM"]:::default
    end
    E -.-> A
    F -.-> D
```

_Figure 1.1. The ESRM Cycle_
...
- **Standards:** More tactical documents that describe how policy expectations should be met. They are more detailed than policies, and they stipulate what _shall_ or _must_ be done.
- **Guidelines:** Similar to standards in that they are tactical and describe how to meet expectations, but they are less rigid than standards and instead provide recommendations and guidance on what _should_ or _may_ be done.
...
ESRM is arguably the most important security concept for security professionals to understand because it is the basis for most or all of what follows. Security professionals should find that the rest of the _Physical Security Audit Manual (PSAM)_ collection as well as other reference guides, standards, guidelines, and other materials are extensions of and built on ESRM. In essence, everything that security professionals do should have ESRM as its basis and driving force.
...
The most significant change is that asset protection is now managed through the principles of ESRM—a methodology for managing risk dynamically, rather than running static programs. The _Enterprise Security Risk Management (ESRM) Guideline_ (2019) defines **risk** as _"the effect of uncertainty on the achievement of strategic, tactical, and operational objectives."_ This concept is a perfect fit for assets protection, where the primary objective is to manage risks by balancing the cost of countermeasures against the value and criticality of the assets protected.
...
Fraud is a constant concern in the workplace. The _Report to the Nations: 2018 Global Study on Occupational Fraud and Abuse_, published by the Association of Certified Fraud Examiners (ACFE), provides critical insights into the scope of this problem.
...
These findings are reinforced by PwC's _Global Economic Crime and Fraud Survey_, which found that more than half of companies had experienced economic crime in the preceding 24 months. Notably:
...
Joseph Wells, founder of the ACFE, expanded on this research in his book _Occupational Fraud and Abuse_, reinforcing that three core elements exist in every fraud:
...
```mermaid
graph TD
    classDef reactive fill:#7f1d1d,stroke:#f87171,stroke-width:2px,color:#fee2e2;
    classDef proactive fill:#064e3b,stroke:#34d399,stroke-width:2px,color:#ecfdf5;
    classDef process fill:#1e293b,stroke:#94a3b8,stroke-width:2px,color:#f8fafc;

    A[1. Incident Discovered]:::reactive --> B[2. Identify Investigative Resources]:::process
    B --> C[3. Action Taken on Findings]:::process
    C --> D[4. Control Temporarily Tightened]:::proactive
    D --> E{Controls Relaxed Over Time?}:::reactive
    E -- Yes --> A
```

_Figure 3.1. Proactive vs. Reactive Controls_
...
graph LR
    ...
    classDef step fill:#0f172a,stroke:#64748b,stroke-width:1px,color:#cbd5e1;

    E1[1. Prevention Programs]:::primary --> E2[2. Incident Tracking]:::step
    E2 --> E3[3. Incident Reporting]:::step
    E3 --> E4[4. Investigation]:::step
    E4 --> E5[5. Action]:::step
    E5 --> E6[6. Resolution]:::primary
    E6 --> E7[7. Analysis]:::step
    E7 --> E8[8. Publication]:::step
    E8 --> E9[9. Implementation of Controls]:::step
    E9 --> E10[10. Compliance Testing]:::primary
```

_Figure 3.2. Comprehensive Model of Theft and Fraud Prevention, Investigation, and Program Testing_
...
_The following was developed by Steven Kirby, CII, Edward R. Kirby and Associates, Elmhurst, Illinois, and is used with permission._
...
(For more details on ROI, see the _Physical Security Audit Manual (PSAM): Business Principles_.)
...
According to industry research, _Persuading Senior Management with Effective, Evaluated Security Metrics_, security professionals can take several concrete steps to ensure metrics are understood by senior executives:
...
The security profession requires various kinds of report writing. For details on incident reporting, refer to the _Physical Security Audit Manual (PSAM): Personnel_. For reports specific to the investigations function, see the _Physical Security Audit Manual (PSAM): Investigations_. This section discusses how security professionals can promote the security function and request funds through a business case.
...
A business case documents all relevant facts and links them together into a cohesive story, telling stakeholders the _what, when, where, how, and why_ of the project.
...
Throughout the Cold War, espionage flourished in both the national security and commercial sectors. Much of the activity targeted _dual-use technologies and information_—those with both military and commercial applications. From the Western perspective, the predominant threat came from Soviet intelligence services, specifically the KGB and its military counterpart, the GRU. The KGB’s Line X (Science and Technology Directorate) and its equivalent agencies in Eastern European states aggressively targeted dual-use technologies from private companies, government agencies, and universities.
...
In the business world, it is often said that _"you cannot manage what you do not measure."_ Security risk assessments must identify threats, quantify them, and prioritize them according to the organization’s criteria for risk acceptance. The output of the assessment directly shapes the selection and prioritization of risk-management actions.
...
_(For detailed specifications on methods and standards for media destruction, refer to Appendix 5A.)_
...
- Mandate that background vetting covers _all_ external trusted parties, temporary contractors, and vendors before they are granted access to protected spaces or networks.
...
- **Data Transparency and Retention:** Clearly mark all collected PII, specifying how the data is utilized, how it is shared, what immediate steps will be taken if a breach occurs, and instructions for its certified destruction or anonymization when the data is _no longer needed_.
...
3. The owner has deployed a _reasonable level of protection_ to maintain its secrecy.
...
- **Pre-Disclosure NDAs:** Execute ironclad Non-Disclosure Agreements with all employees, consultants, outsourcing suppliers, and business partners _before_ any sensitive information is shared.
...
- **Subcontractor NDAs:** Require the primary outsource provider _and_ all of their subcontractors to sign binding corporate Non-Disclosure Agreements.
...
_Based on standards from the National Association for Information Destruction (NAID) and reproduced with permission._
...
- **Recycling is Not Secure Destruction:** Placing files in standard recycling bins does not equal secure destruction. Recycled paper is bundled, transported, and sold in bulk, leaving it exposed to visual scanning or collection. Secure shredding, pulping, or incineration must always occur _before_ the paper fibers are allowed into the recycling stream.
...
- _Is the modern business world more corrupt or unethical than it was in the past?_
- _Can a company remain strictly ethical and still successfully compete in a ruthless market?_
- _Why should anyone care about conducting business in an ethical manner?_
...
1. **Convenience (Expedience):** In a fast-paced business culture focused on speed, individuals frequently boil decisions down to a choice between _what is right_ and _what is easiest_. Human nature often drives people to choose the expedient path over the moral one.
...
_Note: Enactments passed by local municipalities (cities, towns, and villages) are not sovereign and are referred to as **ordinances or local laws**, rather than statutes._
...
Security practitioners must remain proactive and creative, forecasting potential civil, criminal, and regulatory liabilities _before_ deploying any advanced surveillance technology.
...
- _Note:_ Confidential disclosures made by a principal to a member are **not** recognized by law as privileged (unlike attorney-client privilege). In a legal proceeding, a member may be legally required to testify regarding confidential information received from a principal, over the objections of the principal's counsel.
...
- _"A theory about how to gain competitive advantage."_ (Barney 2015)
- _"A set of actions that one firm's managers take in order to outperform the competition."_ (Thompson 2016)
...
1. **Business-Level Strategies:** The specific course of action designed to enable the firm to compete successfully within a _single_ product market or industry. A company achieves a competitive advantage at this level by delivering superior perceived value to the customer—either by offering a standard product at a lower price, a premium product worth paying more for, or a balanced mix of price, features, and service.
2. **Corporate-Level Strategies:** Actions an enterprise takes to achieve a competitive advantage by operating across _multiple_ product markets, industries, or geographic locations simultaneously (Porter 1996).
...
_(For an exhaustive, technical analysis of financial management and corporate metrics, refer to the dedicated **Business Principles** volume of the Physical Security Audit Manual (PSAM).)_
...
graph TD
    ...
    classDef sub fill:#0f172a,stroke:#64748b,stroke-width:2px,color:#cbd5e1;

    A[<b>ORGANATIONAL RESILIENCE</b>]:::main
    A --> B[<b>Emergency Management</b><br>Immediate Physical Response<br>Life Safety & Containment]:::sub
    A --> C[<b>Crisis Management</b><br>Strategic Leadership<br>Brand, Reputation, & Legal]:::sub
    A --> D[<b>Business Continuity</b><br>Operational Resumption<br>System & Process Recovery]:::sub
```
...
1. **Mitigation:** The proactive process of putting physical or structural safeguards in place to reduce the likelihood of a disaster occurring, or to minimize its physical impact if it does occur.
   - _Examples:_ Installing flood barriers, using fire-rated building materials, or anchoring servers and filing cabinets to walls in earthquake zones. Mitigation aims to lessen harm _before_ an event transpires.
...
_Note: Certain specialized industries require highly distinct, dedicated plans. For example, a healthcare facility must deploy fundamentally different protocols to manage a structural earthquake versus a highly contagious biological outbreak._
...
_Ideally, all CMT members and their alternates must be designated by position title rather than individual name, ensuring seamless continuity of command if a specific individual is absent._
...
A dedicated **threat evaluation team** should be established to systematically catalog and assess all threats received by the organization, ensuring assessments are conducted early enough to draft and test recovery procedures _before_ they are needed.
...
graph TD
    ...
    A[<b>1. Define Mission & Critical Assets</b>]:::start --> B[<b>2. Conduct Risk Assessment & BIA</b>]:::step
    B --> C[<b>3. Draft EOP & BCM Checklists</b>]:::step
    C --> D[<b>4. Train Recovery Personnel</b>]:::step
    D --> E[<b>5. Test Plan via Tabletop/Simulations</b>]:::step
    E --> F[<b>6. Audit & Revise Procedures</b>]:::step
    F --> B
```
...
graph TD
    %% Define HSL-themed styles
    classDef immediate fill:#7f1d1d,stroke:#f87171,stroke-width:2px,color:#fee2e2;
    classDef shortTerm fill:#7c2d12,stroke:#f97316,stroke-width:2px,color:#fff7ed;
    classDef longTerm fill:#1e3a8a,stroke:#60a5fa,stroke-width:2px,color:#eff6ff;
    classDef default fill:#1e293b,stroke:#94a3b8,stroke-width:2px,color:#f8fafc;

    A[<b>Active Assailant Event</b>]:::default --> B[<b>1. Immediate Phase</b><br>• Life Safety First<br>• Account for Personnel<br>• Initial Alert/Comms]:::immediate
    B --> C[<b>2. Short-Term Phase</b><br>• Preserve Crime Scene<br>• Trauma Monitoring<br>• Reunification & Info Flow]:::shortTerm
    C --> D[<b>3. Long-Term Phase</b><br>• Post-Incident Debriefs<br>• Replenish Critical Supplies<br>• Ongoing Stakeholder Comms]:::longTerm
```
...
graph LR
    ...
    Phase1[<b>1. Initiation</b><br>Incident report, complaint, or audit finding trigger]:::step --> Phase2[<b>2. Investigation</b><br>Fact-gathering, interviews, & forensic analysis]:::step
    Phase2 --> Phase3[<b>3. Reporting</b><br>Drafting objective logs, statements, & files]:::step
    Phase3 --> Phase4[<b>4. Leverage</b><br>Root-cause analysis, policy updates, & risk mitigation]:::highlight
```
...
Unlike passive surveillance, undercover operations are interactive. A skilled operative can not only observe _what_ misconduct is occurring but also uncover the _how_ and _why_ behind the actions, including peer pressure, supervisory complicity, and systemic workarounds.
...
> Under the doctrine of **negligent hiring**, employers are held legally liable for the intentional misconduct or violence of an employee if it is proven that the employer knew, or _should have known_ through reasonable background screening, that the individual posed a threat to coworkers, clients, or the public.
...
graph TD
    %% Define HSL-themed styles
    classDef protocol fill:#1e293b,stroke:#475569,stroke-width:2px,color:#f8fafc;
    classDef alert fill:#7f1d1d,stroke:#f87171,stroke-width:2px,color:#fee2e2;

    A[<b>Physical/Digital Evidence Detected</b>]:::protocol --> B[<b>1. Secure and Document</b><br>Photograph, log location, and describe]:::protocol
    B --> C[<b>2. Package and Label</b><br>Seal in tamper-evident bag with unique ID]:::protocol
    C --> D[<b>3. Log Chain of Custody</b><br>Document every transfer of custody: Who, When, Why]:::protocol
    D --> E[<b>4. Secure Storage</b><br>Store in double-locked, restricted access locker]:::protocol
    E --> F[<b>Evidence Compromised?</b><br>Any gap in the chain makes evidence inadmissible]:::alert
```
...
The ultimate product of an investigation is the **investigative report**. This formal, written record must be clear, objective, and logical, enabling the reader to easily understand _what_ the investigator did, _why_ it was done, and _what_ resulted. IUs typically utilize four classes of reports:
...
_To protect individual privacy and shield the enterprise from liability, report distribution must be strictly restricted to individuals with a documented, genuine "need-to-know" (e.g., Legal Counsel, HR Director, and designating Executive)._
...
graph TD
    %% Define HSL-themed styles
    classDef roles fill:#1e293b,stroke:#475569,stroke-width:2px,color:#f8fafc;
    classDef main fill:#0f172a,stroke:#3b82f6,stroke-width:2px,color:#eff6ff;

    A[<b>UNIFORMED OFFICER FUNCTIONS</b>]:::main
    A --> B[<b>Access & Traffic Control</b><br>Pedestrian & vehicle verification<br>Visitor management & screening]:::roles
    A --> C[<b>Patrols & Inspections</b><br>Building & perimeter rounds<br>Fire & safety hazard identification]:::roles
    A --> D[<b>Operational Monitoring</b><br>Central control room supervision<br>CCTV, access logs, & alarm response]:::roles
    A --> E[<b>Emergency Response</b><br>Immediate incident containment<br>First-responder coordination]:::roles
    A --> F[<b>Safety & Reporting</b><br>Accident prevention audits<br>Incident documentation & logs]:::roles
```
...
_Less-Lethal Weapons:_ Tools such as electroshock devices (Tasers), expandable batons, and chemical irritants (pepper spray) are also inherently dangerous. Officers must undergo standardized certification to ensure these tools are used judiciously, preventing excessive force claims and minimizing organizational liability.
...
graph TD
    ...
    A[<b>1. Needs Analysis & Site Survey</b><br>Establish clear business case & scope of work]:::start --> B[<b>2. Draft RFP</b><br>Specify mandatory hourly pay rates, not just bill rates]:::step
    B --> C[<b>3. Bidders' Conference & Facility Tour</b><br>Conduct walking tour to explain officer duties in detail]:::step
    C --> D[<b>4. Proposal Evaluation</b><br>Compare candidates on price, quality, & geographic experience]:::step
    D --> E[<b>5. Draft Operating Agreement</b><br>Define precise responsibilities & SLA metrics]:::step
```
...
graph TD
    ...
    classDef step fill:#0f172a,stroke:#475569,stroke-width:2px,color:#cbd5e1;

    A[<b>THE FOUR Ds FRAMEWORK</b>]:::primary
    A --> B[<b>1. Deter</b><br>Discourage adversaries through visible barriers, warning signs, and active patrols]:::step
    A --> C[<b>2. Detect</b><br>Identify unauthorized entry attempts using intrusion sensors, PACS alerts, and CCTV]:::step
    A --> D[<b>3. Delay</b><br>Slow down adversary penetration using reinforced locks, fences, and target hardening]:::step
    A --> E[<b>4. Deny</b><br>Prevent access to high-value assets and initiate physical or law enforcement intercept]:::step
```
...
A primary mathematical and logical concept in security engineering is the **Critical Detection Point**. This represents the absolute boundary in the adversary's timeline where detection _must_ occur if the response force is to successfully intercept the intruder before they reach the high-value asset:
...
graph TD
    %% Define HSL-themed styles
    classDef concept fill:#1e293b,stroke:#475569,stroke-width:2px,color:#f8fafc;
    classDef mode fill:#1e3a8a,stroke:#3b82f6,stroke-width:2px,color:#eff6ff;
    classDef main fill:#0f172a,stroke:#10b981,stroke-width:2px,color:#ecfdf5;

    A[<b>CPTED FRAMEWORK</b>]:::main

    A --> B[<b>Three Core Concepts</b>]:::concept
    B --> B1[<b>Territoriality:</b> Design spaces to express ownership & define clean boundaries]:::concept
    B --> B2[<b>Natural Surveillance:</b> Maximize visibility & sightlines to keep space under passive observation]:::concept
    B --> B3[<b>Natural Access Control:</b> Guide pedestrian/vehicular traffic through defined entry paths]:::concept

    A --> C[<b>Three Implementation Modes</b>]:::mode
    C --> C1[<b>Natural:</b> Landscape design, architectural pathways, terrain features]:::mode
    C --> C2[<b>Mechanical:</b> Electronic security, gates, CPTED-rated lighting, physical hardware]:::mode
    C --> C3[<b>Organizational:</b> Security officer patrols, visitor policies, neighborhood watches]:::mode
```
...
While credentials or PINs only verify that the person requesting entry _possesses_ the token or _knows_ the number, **biometric devices positive-verify the actual identity** of the specific individual. Combining multiple verification factors (e.g., Proximity Card + PIN + Fingerprint Scan) drastically hardens high-security access points (such as server rooms or executive vaults) at the expense of user throughput.
...
graph LR
    ...
    SD1[<b>1. Planning & Assessment</b><br>Identify assets, threats, & vulnerabilities]:::step --> SD2[<b>2. Requirements Analysis</b><br>Formulate pro-active, verified concepts]:::step
    SD2 --> SD3[<b>3. Design & Spec</b><br>Draft technical drawings & datasheets]:::step
    SD3 --> SD4[<b>4. Implementation</b><br>Contractor installation & calibration]:::step
    SD4 --> SD5[<b>5. Acceptance Testing</b><br>Stress-test system under threat limits]:::step
    SD5 --> SD6[<b>6. Follow-On Maintenance</b><br>Preventive/remedial support]:::highlight
```
...
The global security landscape is shaped by complex, interconnected risks that transcend traditional physical boundaries. Writing in the wake of the global COVID-19 pandemic, risk analysts note that the crisis severely exacerbated pre-existing societal divisions, fractured economic stability, and introduced novel vulnerabilities across both public and private sectors. According to the World Economic Forum's (WEF) _Global Risks Report_, "social cohesion erosion" and "livelihood crises" represent dominant, high-impact disruptions.
...
2. **Target Hardening:** Lock down perimeters, secure glass exposures, test backup generators, and prepare emergency communications _before_ the demonstration reaches the facility.
...
graph TD
    %% Define HSL-themed styles
    classDef tactics fill:#1e293b,stroke:#475569,stroke-width:2px,color:#f8fafc;
    classDef target fill:#7f1d1d,stroke:#f87171,stroke-width:2px,color:#fee2e2;
    classDef main fill:#0f172a,stroke:#3b82f6,stroke-width:2px,color:#eff6ff;

    A[<b>TERRORIST TARGETING MATRIX</b>]:::main
    A --> B[<b>Strategic Targets</b><br>Economic & political symbols<br>Critical national infrastructure]:::target
    A --> C[<b>Asymmetric Tactics</b><br>Active shooters & hostage taking<br>Improvised explosive devices<br>Suicide & vehicle ramming attacks]:::tactics
    A --> D[<b>Emerging Threat Vectors</b><br>Cyberwarfare & system sabotage<br>Internet-facilitated recruitment<br>Supply-chain infiltration]:::tactics
```
