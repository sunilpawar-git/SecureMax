...
# ============================================================================
if echo "$DIFF" | grep -qE "gh[pousr]_[A-Za-z0-9_]{36,255}"; then
...
# ============================================================================
if echo "$DIFF" | grep -qEi 'DB_PASSWORD=|postgres://[^:]+:[^@]{8,}@[^l]'; then
...
# 5. NextAuth Secrets
# ============================================================================
if echo "$DIFF" | grep -qEi 'NEXTAUTH_SECRET=|AUTH_SECRET='; then
...
# ============================================================================
if echo "$DIFF" | grep -qEi 'CLIENT_SECRET=|OAUTH_SECRET=|GOOGLE_CLIENT_SECRET='; then
...
# 7. Razorpay Keys
# ============================================================================
if echo "$DIFF" | grep -qEi 'RAZORPAY_KEY=|RAZORPAY_SECRET='; then
...
# ============================================================================
if echo "$DIFF" | grep -qE -- '-----BEGIN (RSA|OPENSSH|PGP) PRIVATE KEY|PRIVATE KEY-----'; then
