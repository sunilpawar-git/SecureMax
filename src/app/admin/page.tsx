  ...
  return (
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <section>
          <h2 className="text-lg font-semibold text-slate-900 dark:text-slate-100 mb-3">Action Items</h2>
          <ActionItems items={actionItems ?? EMPTY_ACTION_ITEMS} />
        </section>
        <section>
          <h2 className="text-lg font-semibold text-slate-900 dark:text-slate-100 mb-3">Recent Activity</h2>
