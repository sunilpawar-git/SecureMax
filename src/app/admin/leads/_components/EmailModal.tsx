...
export function EmailModal({ lead, onSend, onClose }: EmailModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40">
      ...
      >
        <h2 id="dialog-title" className="text-lg font-semibold text-slate-900 dark:text-slate-100 mb-1">Send Email</h2>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            <label htmlFor="email-body" className="text-sm font-medium text-slate-700 dark:text-slate-200">
              Body
            </label>
            <textarea
              id="email-body"
