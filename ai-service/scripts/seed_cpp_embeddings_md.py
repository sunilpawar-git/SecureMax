"""
Seeds cpp_chunks table from CPP Seven Precis Markdown files.
...
async def main() -> None:
    ...
    if not PDF_DIR.exists():
        ...
        print("Place CPP markdown files in the cpp-pdfs/ directory and re-run.")
    ...
    if not all_chunks:
        print("No chunks generated — check markdown files")
        return
